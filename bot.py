...
async def send_welcome(message: types.Message):
    await message.answer("Привет! Я бот для отслеживания курса криптовалют. Нажмите на кнопку для получения курса.",
...
scheduler.add_job(scheduled_price_check, "interval", minutes=1)  # Автозапрос каждые 2 часа
scheduler.start()
